...
/****************************************************************/
#ifndef ANAFINITESTRAINUOBASEDCP_H
#define ANAFINITESTRAINUOBASEDCP_H
...
class anaFiniteStrainUObasedCP;
 ...
 */
class anaFiniteStrainUObasedCP : public ComputeStressBase
{
public:
  anaFiniteStrainUObasedCP(const InputParameters & parameters);
...
protected:
  ...
  */
  ...
  std::vector<const anaCrystalPlasticitySlipRateGSS *> _uo_slip_rates;

  /// User objects that define the slip resistance
  std::vector<const anaCrystalPlasticitySlipResistanceGSS *> _uo_slip_resistances;

  /// User objects that define the state variable
  std::vector<const anaCrystalPlasticityStateVariable *> _uo_state_vars;

  /// User objects that define the state variable evolution rate component
  std::vector<const anaCrystalPlasticityStateVarRateComponentGSS *> _uo_state_var_evol_rate_comps;
...
#endif //ANAFINITESTRAINUOBASEDCP_H
