...
/****************************************************************/
#ifndef STZANAFINITESTRAINUOBASEDCPCOUPLE_H
#define STZANAFINITESTRAINUOBASEDCPCOUPLE_H
...
class stzanaFiniteStrainUObasedCPCouple;
 ...
 */
class stzanaFiniteStrainUObasedCPCouple : public ComputeStressBase
{
public:
  stzanaFiniteStrainUObasedCPCouple(const InputParameters & parameters);
...
protected:
  ...
  */
  ...
  std::vector<const stzanaCrystalPlasticitySlipRateGSSCouple *> _uo_slip_rates;

  /// User objects that define the slip resistance
  std::vector<const stzanaCrystalPlasticitySlipResistanceGSSCouple *> _uo_slip_resistances;

  /// User objects that define the state variable
  std::vector<const stzanaCrystalPlasticityStateVariableCouple *> _uo_state_vars;

  /// User objects that define the state variable evolution rate component
  std::vector<const stzanaCrystalPlasticityStateVarRateComponentGSSCouple *> _uo_state_var_evol_rate_comps;
  ...
  MaterialProperty<Real> & _sdplcouple;
...
#endif //STZANAFINITESTRAINUOBASEDCPCOUPLE_H
