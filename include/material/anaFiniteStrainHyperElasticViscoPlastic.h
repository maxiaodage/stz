...
/****************************************************************/
#ifndef ANAFINITESTRAINHYPERELASTICVISCOPLASTIC_H
#define ANAFINITESTRAINHYPERELASTICVISCOPLASTIC_H
...
class anaFiniteStrainHyperElasticViscoPlastic;
 ...
 */
class anaFiniteStrainHyperElasticViscoPlastic : public ComputeStressBase
{
public:
  anaFiniteStrainHyperElasticViscoPlastic (const InputParameters & parameters);
...
#endif //ANAFINITESTRAINHYPERELASTICVISCOPLASTIC_H
