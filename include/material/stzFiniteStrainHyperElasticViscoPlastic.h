...
/****************************************************************/
#ifndef STZFINITESTRAINHYPERELASTICVISCOPLASTIC_H
#define STZFINITESTRAINHYPERELASTICVISCOPLASTIC_H
...
class stzFiniteStrainHyperElasticViscoPlastic;
 ...
 */
class stzFiniteStrainHyperElasticViscoPlastic : public ComputeStressBase
{
public:
  stzFiniteStrainHyperElasticViscoPlastic (const InputParameters & parameters);
...
#endif //STZFINITESTRAINHYPERELASTICVISCOPLASTIC_H
