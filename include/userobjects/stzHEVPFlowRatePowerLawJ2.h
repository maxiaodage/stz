...
/****************************************************************/
#ifndef STZHEVPFLOWRATEPOWERLAWJ2_H
#define STZHEVPFLOWRATEPOWERLAWJ2_H

#include "HEVPFlowRateUOBase.h"


class stzHEVPFlowRatePowerLawJ2;
 ...
 */
class stzHEVPFlowRatePowerLawJ2 : public HEVPFlowRateUOBase
{
public:
  stzHEVPFlowRatePowerLawJ2(const InputParameters & parameters);
