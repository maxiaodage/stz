...
/****************************************************************/
#ifndef STZANACRYSTALPLASTICITYSTATEVARIABLE_H
#define STZANACRYSTALPLASTICITYSTATEVARIABLE_H

#include "CrystalPlasticityStateVariable.h"

class stzanaCrystalPlasticityStateVariable;
 ...
 */
class stzanaCrystalPlasticityStateVariable : public CrystalPlasticityStateVariable
{
public:
  stzanaCrystalPlasticityStateVariable(const InputParameters & parameters);
...
#endif // STZANACRYSTALPLASTICITYSTATEVARIABLE_H
