...
/****************************************************************/
#ifndef STZANACRYSTALPLASTICITYSTATEVARIABLECOUPLE_H
#define STZANACRYSTALPLASTICITYSTATEVARIABLECOUPLE_H

#include "CrystalPlasticityStateVariable.h"

class stzanaCrystalPlasticityStateVariableCouple;
 ...
 */
class stzanaCrystalPlasticityStateVariableCouple : public CrystalPlasticityStateVariable
{
public:
  stzanaCrystalPlasticityStateVariableCouple(const InputParameters & parameters);
...
#endif // STZANACRYSTALPLASTICITYSTATEVARIABLECOUPLE_H
