...
/****************************************************************/
#ifndef STZRHEVPFLOWRATEPOWERLAWJ2_H
#define STZRHEVPFLOWRATEPOWERLAWJ2_H

#include "HEVPFlowRateUOBase.h"


class stzRHEVPFlowRatePowerLawJ2;
 ...
 */
class stzRHEVPFlowRatePowerLawJ2 : public HEVPFlowRateUOBase
{
public:
  stzRHEVPFlowRatePowerLawJ2(const InputParameters & parameters);
