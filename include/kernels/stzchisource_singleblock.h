...
/****************************************************************/
#ifndef STZCHISOURCE_SINGLEBLOCK_H
#define STZCHISOURCE_SINGLEBLOCK_H

#include "BodyForce.h"

//Forward Declarations
class stzchisource_singleblock;
class Function;
...
class stzchisource_singleblock : public BodyForce
{
public:

  stzchisource_singleblock(const InputParameters & parameters);
