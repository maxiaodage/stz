...
#ifndef STZMECHANICALCONTACTCONSTRAINT_H
#define STZMECHANICALCONTACTCONSTRAINT_H
...
class stzMechanicalContactConstraint;
...
{
public:
  stzMechanicalContactConstraint(const InputParameters & parameters);
  virtual ~stzMechanicalContactConstraint(){}
