...
/****************************************************************/
#ifndef STZHEATCONDUCTIONTIMEDERIVATIVECOUPLE_H
#define STZHEATCONDUCTIONTIMEDERIVATIVECOUPLE_H
...
class stzHeatConductionTimeDerivativeCouple;

template<>
InputParameters validParams<stzHeatConductionTimeDerivativeCouple>();
 ...
 */
class stzHeatConductionTimeDerivativeCouple : public TimeDerivative
{
public:
  /// Contructor for Heat Equation time derivative term.
  stzHeatConductionTimeDerivativeCouple(const InputParameters & parameters);
...
#endif //STZHEATCONDUCTIONTIMEDERIVATIVECOUPLE_H
