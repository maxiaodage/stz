...
/****************************************************************/
#ifndef STZHEATCONDUCTIONTIMEDERIVATIVE_H
#define STZHEATCONDUCTIONTIMEDERIVATIVE_H
...
class stzHeatConductionTimeDerivative;

template<>
InputParameters validParams<stzHeatConductionTimeDerivative>();
 ...
 */
class stzHeatConductionTimeDerivative : public TimeDerivative
{
public:
  /// Contructor for Heat Equation time derivative term.
  stzHeatConductionTimeDerivative(const InputParameters & parameters);
...
#endif //STZHEATCONDUCTIONTIMEDERIVATIVE_H
