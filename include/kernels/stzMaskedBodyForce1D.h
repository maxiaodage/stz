...
/****************************************************************/
#ifndef STZMASKEDBODYFORCE1D_H
#define STZMASKEDBODYFORCE1D_H

#include "BodyForce.h"

//Forward Declarations
class stzMaskedBodyForce1D;
class Function;

template<>
InputParameters validParams<stzMaskedBodyForce1D>();
...
class stzMaskedBodyForce1D : public BodyForce
{
public:

  stzMaskedBodyForce1D(const InputParameters & parameters);
