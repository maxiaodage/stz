...
#ifndef STZIMPLICITODES_H
#define STZIMPLICITODES_H
 ...
 */
template <>
InputParameters validParams<stzImplicitODEs>();

/**
 * ODE: x' = 3 * x + 2 * y
 */
class stzImplicitODEs : public ODEKernel
{
public:
  /**
   * Constructor
   */
  stzImplicitODEs(const InputParameters & parameters);
