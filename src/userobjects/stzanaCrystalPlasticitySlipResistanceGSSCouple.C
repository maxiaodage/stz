...
stzanaCrystalPlasticitySlipResistanceGSSCouple::stzanaCrystalPlasticitySlipResistanceGSSCouple(const InputParameters & parameters) :
...
bool
stzanaCrystalPlasticitySlipResistanceGSSCouple::calcSlipResistance(unsigned int qp, std::vector<Real> & val) const
{
