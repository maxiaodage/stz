...
template<>
InputParameters validParams<stzanaCrystalPlasticityStateVariable>()
{
...
stzanaCrystalPlasticityStateVariable::stzanaCrystalPlasticityStateVariable(const InputParameters & parameters) :
...
void
stzanaCrystalPlasticityStateVariable::initSlipSysProps(std::vector<Real> & val, Real xcoord, Real ycoord, Real zcoord) const
{
...
void
stzanaCrystalPlasticityStateVariable::readInitialValueFromFile(std::vector<Real> & val) const
{
...
void
stzanaCrystalPlasticityStateVariable::readInitialValueFromInline(std::vector<Real> & val,Real xcoord, Real ycoord, Real zcoord) const
{
//  std::cout<<"xcoord"<<xcoord<<"y"<<ycoord<<"z"<<zcoord<<"\n";
...
bool
stzanaCrystalPlasticityStateVariable::updateStateVariable(unsigned int qp, Real dt, std::vector<Real> & val) const
{
  // Anand
  for (unsigned int i = 0; i < _variable_size; ++i)
  {
