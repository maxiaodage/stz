...
anaHEVPLinearHardening::anaHEVPLinearHardening(const InputParameters & parameters) :
...
bool
anaHEVPLinearHardening::computeValue(unsigned int qp, Real & val) const
{
...
bool
anaHEVPLinearHardening::computeDerivative(unsigned int /*qp*/, const std::string & coupled_var_name, Real & val) const
{
  val = 0;
