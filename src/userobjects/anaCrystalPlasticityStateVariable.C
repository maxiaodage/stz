...
InputParameters validParams<anaCrystalPlasticityStateVariable>()
{
  ...
  params.addParam<Real>("inclusionvalue", 0.001,"Inclusion value of internal variable");
  params.addParam<Real>("backgroundvalue", 0.001,"Background value of internal variable");
...
anaCrystalPlasticityStateVariable::anaCrystalPlasticityStateVariable(const InputParameters & parameters) :
...
void
anaCrystalPlasticityStateVariable::initSlipSysProps(std::vector<Real> & val, Real xcoord, Real ycoord, Real zcoord) const
{
...
void
anaCrystalPlasticityStateVariable::readInitialValueFromFile(std::vector<Real> & val) const
{
...
void
anaCrystalPlasticityStateVariable::readInitialValueFromInline(std::vector<Real> & val,Real xcoord, Real ycoord, Real zcoord) const
{
//  std::cout<<"xcoord"<<xcoord<<"y"<<ycoord<<"z"<<zcoord<<"\n";
...
bool
anaCrystalPlasticityStateVariable::updateStateVariable(unsigned int qp, Real dt, std::vector<Real> & val) const
{
  // Anand
  for (unsigned int i = 0; i < _variable_size; ++i)
  {
