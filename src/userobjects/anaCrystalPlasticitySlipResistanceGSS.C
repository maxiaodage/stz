...
anaCrystalPlasticitySlipResistanceGSS::anaCrystalPlasticitySlipResistanceGSS(const InputParameters & parameters) :
...
bool
anaCrystalPlasticitySlipResistanceGSS::calcSlipResistance(unsigned int qp, std::vector<Real> & val) const
{
