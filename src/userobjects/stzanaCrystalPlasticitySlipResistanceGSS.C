...
stzanaCrystalPlasticitySlipResistanceGSS::stzanaCrystalPlasticitySlipResistanceGSS(const InputParameters & parameters) :
...
bool
stzanaCrystalPlasticitySlipResistanceGSS::calcSlipResistance(unsigned int qp, std::vector<Real> & val) const
{
