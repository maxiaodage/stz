...
template<>
InputParameters validParams<anaCrystalPlasticityStateVarRateComponentGSS>()
{
...
anaCrystalPlasticityStateVarRateComponentGSS::anaCrystalPlasticityStateVarRateComponentGSS(const InputParameters & parameters) :
...
bool
anaCrystalPlasticityStateVarRateComponentGSS::calcStateVariableEvolutionRateComponent(unsigned int qp, std::vector<Real> & val) const
{
