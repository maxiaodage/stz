...
stzanaCrystalPlasticitySlipRateGSS::stzanaCrystalPlasticitySlipRateGSS(const InputParameters & parameters) :
...
void
stzanaCrystalPlasticitySlipRateGSS::readFileFlowRateParams()
{
...
void
stzanaCrystalPlasticitySlipRateGSS::getFlowRateParams()
{
...
void
stzanaCrystalPlasticitySlipRateGSS::calcFlowDirection(unsigned int qp, std::vector<RankTwoTensor> & flow_direction) const
{
...
void
stzanaCrystalPlasticitySlipRateGSS::calcFlowDirectionnormal(unsigned int qp, std::vector<RankTwoTensor> & flow_direction_normal) const
{
...
void
stzanaCrystalPlasticitySlipRateGSS::calcFlowDirections(unsigned int qp, std::vector<RankTwoTensor> & flow_direction_s) const
{
  DenseVector<Real> mo(LIBMESH_DIM*_variable_size),no(LIBMESH_DIM*_variable_size);
  // Update slip direction and normal with crystal orientation
  std::vector<Real> eigval(3, 0.0);
...
bool
stzanaCrystalPlasticitySlipRateGSS::calcSlipRate(unsigned int qp, Real dt, std::vector<Real> & val) const
{
...
bool
stzanaCrystalPlasticitySlipRateGSS::calcSlipRateDerivative(unsigned int qp, Real /*dt*/, std::vector<Real> & val) const
{
//   DenseVector<Real> tau(_variable_size);
//   DenseVector<Real> sigma(_variable_size);
//
