...
template<>
InputParameters validParams<stzanaCrystalPlasticityStateVarRateComponentGSS>()
{
...
stzanaCrystalPlasticityStateVarRateComponentGSS::stzanaCrystalPlasticityStateVarRateComponentGSS(const InputParameters & parameters) :
...
bool
stzanaCrystalPlasticityStateVarRateComponentGSS::calcStateVariableEvolutionRateComponent(unsigned int qp, std::vector<Real> & val) const
{
