...
template <>
InputParameters
validParams<stzplasticrateAux_scalars>()
{
...
stzplasticrateAux_scalars::stzplasticrateAux_scalars(const InputParameters & parameters)
 ...
 */
Real
stzplasticrateAux_scalars::computeValue()
{
