...
template<>
InputParameters validParams<stzFiniteStrainHyperElasticViscoPlastic>()
{
...
stzFiniteStrainHyperElasticViscoPlastic::stzFiniteStrainHyperElasticViscoPlastic(const InputParameters & parameters) :
...
void
stzFiniteStrainHyperElasticViscoPlastic::initUOVariables()
{
...
void
stzFiniteStrainHyperElasticViscoPlastic::initNumUserObjects(const std::vector<UserObjectName> & uo_names, unsigned int & uo_num)
{
...
template <typename T>
void
stzFiniteStrainHyperElasticViscoPlastic::initProp(const std::vector<UserObjectName> & uo_names, unsigned int uo_num, std::vector<MaterialProperty<T> *> & uo_prop)
{
...
template <typename T>
void
stzFiniteStrainHyperElasticViscoPlastic::initPropOld(const std::vector<UserObjectName> & uo_names, unsigned int uo_num, std::vector<MaterialProperty<T> *> & uo_prop_old)
{
...
template <typename T>
void
stzFiniteStrainHyperElasticViscoPlastic::initUserObjects(const std::vector<UserObjectName> & uo_names, unsigned int uo_num, std::vector<const T *> & uo)
{
  uo.resize(uo_num);
...
void
stzFiniteStrainHyperElasticViscoPlastic::initJacobianVariables()
{
...
void
stzFiniteStrainHyperElasticViscoPlastic::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeQpStress()
{
  bool converge;
...
void
stzFiniteStrainHyperElasticViscoPlastic::saveOldState()
{
  for (unsigned int i = 0; i < _num_int_var_uos; ++i)
...
void
stzFiniteStrainHyperElasticViscoPlastic::preSolveQp()
{
...
bool
stzFiniteStrainHyperElasticViscoPlastic::solveQp()
{
  preSolveFlowrate();
  if (!solveFlowrate())
    return false;
...
void
stzFiniteStrainHyperElasticViscoPlastic::postSolveQp()
{
  recoverOldState();
...
void
stzFiniteStrainHyperElasticViscoPlastic::recoverOldState()
{
  for (unsigned int i = 0; i < _num_int_var_uos; ++i)
...
void
stzFiniteStrainHyperElasticViscoPlastic::preSolveFlowrate()
{
  for (unsigned int i = 0; i < _num_flow_rate_uos; ++i)
  {
    _flow_rate(i) = 0.0;
...
bool
stzFiniteStrainHyperElasticViscoPlastic::solveFlowrate()
{
  Real resid0, rnorm;
  unsigned int iter = 0;
  ...
  //while (rnorm > _resid_rel_tol * resid0 && iter < _maxiters)
  {
  ...
  //std::cout <<"hah"<<iter<<"hah"<<"\n"<<"rnorm"<<rnorm<<"_resid_rel_tol * resid0"<<_resid_rel_tol * resid0;
...
void
stzFiniteStrainHyperElasticViscoPlastic::postSolveFlowrate()
{
...
bool
stzFiniteStrainHyperElasticViscoPlastic::computeFlowRateResidual()
{
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeFlowRateJacobian()
{
...
bool
stzFiniteStrainHyperElasticViscoPlastic::computeFlowDirection()
{
...
bool
stzFiniteStrainHyperElasticViscoPlastic::computeFlowRateFunction()
{
  Real val = 0;
  for (unsigned i = 0; i < _num_flow_rate_uos; ++i)
  {
...
void
stzFiniteStrainHyperElasticViscoPlastic::computePK2StressAndDerivative()
{
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeElasticStrain()
{
  RankTwoTensor iden;
  iden.addIa(1.0);
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeDeeDce()
{
  _dee_dce.zero();
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeElasticRightCauchyGreenTensor()
{
  _ce[_qp] = _fe.transpose() * _fe;
}

void
stzFiniteStrainHyperElasticViscoPlastic::computeElasticPlasticDeformGrad()
{
  RankTwoTensor iden;
  iden.addIa(1.0);
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeDpk2Dfpinv()
{
  for (unsigned int i = 0; i < LIBMESH_DIM; ++i)
    for (unsigned int j = 0; j < LIBMESH_DIM; ++j)
      for (unsigned int k = 0; k < LIBMESH_DIM; ++k)
...
Real
stzFiniteStrainHyperElasticViscoPlastic::computeNorm(const std::vector<Real> & var)
{
  Real val = 0.0;
...
void
stzFiniteStrainHyperElasticViscoPlastic::updateFlowRate()
{
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeQpJacobian()
{
...
bool
stzFiniteStrainHyperElasticViscoPlastic::computeIntVarRates()
{
  Real val = 0;
  for (unsigned int i = 0; i < _num_int_var_rate_uos; ++i)
  {
...
bool
stzFiniteStrainHyperElasticViscoPlastic::computeIntVar()
{
  Real val = 0;
  for (unsigned int i = 0; i < _num_int_var_uos; ++i)
  {
...
bool
stzFiniteStrainHyperElasticViscoPlastic::computeStrength()
{
  Real val = 0;
  for (unsigned int i = 0; i < _num_strength_uos; ++i)
  {
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeIntVarRateDerivatives()
{
  Real val = 0;
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeIntVarDerivatives()
{
  Real val = 0;
...
void
stzFiniteStrainHyperElasticViscoPlastic::computeStrengthDerivatives()
{
  Real val = 0;
