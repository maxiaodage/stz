...
template<>
InputParameters validParams<anaComputeElasticityTensorCP>()
{
...
anaComputeElasticityTensorCP::anaComputeElasticityTensorCP(const InputParameters & parameters) :
...
void
anaComputeElasticityTensorCP::assignEulerAngles()
{
...
void
anaComputeElasticityTensorCP::computeQpElasticityTensor()
{
