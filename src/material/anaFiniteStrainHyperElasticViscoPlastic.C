...
template<>
InputParameters validParams<anaFiniteStrainHyperElasticViscoPlastic>()
{
...
anaFiniteStrainHyperElasticViscoPlastic::anaFiniteStrainHyperElasticViscoPlastic(const InputParameters & parameters) :
...
void
anaFiniteStrainHyperElasticViscoPlastic::initUOVariables()
{
...
void
anaFiniteStrainHyperElasticViscoPlastic::initNumUserObjects(const std::vector<UserObjectName> & uo_names, unsigned int & uo_num)
{
...
template <typename T>
void
anaFiniteStrainHyperElasticViscoPlastic::initProp(const std::vector<UserObjectName> & uo_names, unsigned int uo_num, std::vector<MaterialProperty<T> *> & uo_prop)
{
...
template <typename T>
void
anaFiniteStrainHyperElasticViscoPlastic::initPropOld(const std::vector<UserObjectName> & uo_names, unsigned int uo_num, std::vector<MaterialProperty<T> *> & uo_prop_old)
{
...
template <typename T>
void
anaFiniteStrainHyperElasticViscoPlastic::initUserObjects(const std::vector<UserObjectName> & uo_names, unsigned int uo_num, std::vector<const T *> & uo)
{
  uo.resize(uo_num);
...
void
anaFiniteStrainHyperElasticViscoPlastic::initJacobianVariables()
{
...
void
anaFiniteStrainHyperElasticViscoPlastic::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeQpStress()
{
  bool converge;
...
void
anaFiniteStrainHyperElasticViscoPlastic::saveOldState()
{
  for (unsigned int i = 0; i < _num_int_var_uos; ++i)
...
void
anaFiniteStrainHyperElasticViscoPlastic::preSolveQp()
{
...
bool
anaFiniteStrainHyperElasticViscoPlastic::solveQp()
{
  preSolveFlowrate();
  if (!solveFlowrate())
    return false;
...
void
anaFiniteStrainHyperElasticViscoPlastic::postSolveQp()
{
  recoverOldState();
...
void
anaFiniteStrainHyperElasticViscoPlastic::recoverOldState()
{
  for (unsigned int i = 0; i < _num_int_var_uos; ++i)
...
void
anaFiniteStrainHyperElasticViscoPlastic::preSolveFlowrate()
{
  for (unsigned int i = 0; i < _num_flow_rate_uos; ++i)
  {
    _flow_rate(i) = 0.0;
...
bool
anaFiniteStrainHyperElasticViscoPlastic::solveFlowrate()
{
  Real resid0, rnorm;
  unsigned int iter = 0;
...
void
anaFiniteStrainHyperElasticViscoPlastic::postSolveFlowrate()
{
...
bool
anaFiniteStrainHyperElasticViscoPlastic::computeFlowRateResidual()
{
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeFlowRateJacobian()
{
...
bool
anaFiniteStrainHyperElasticViscoPlastic::computeFlowDirection()
{
...
bool
anaFiniteStrainHyperElasticViscoPlastic::computeFlowRateFunction()
{
  Real val = 0;
  for (unsigned i = 0; i < _num_flow_rate_uos; ++i)
  {
...
void
anaFiniteStrainHyperElasticViscoPlastic::computePK2StressAndDerivative()
{
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeElasticStrain()
{
  RankTwoTensor iden;
  iden.addIa(1.0);
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeDeeDce()
{
  _dee_dce.zero();
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeElasticRightCauchyGreenTensor()
{
  _ce[_qp] = _fe.transpose() * _fe;
}

void
anaFiniteStrainHyperElasticViscoPlastic::computeElasticPlasticDeformGrad()
{
  RankTwoTensor iden;
  iden.addIa(1.0);
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeDpk2Dfpinv()
{
  for (unsigned int i = 0; i < LIBMESH_DIM; ++i)
    for (unsigned int j = 0; j < LIBMESH_DIM; ++j)
      for (unsigned int k = 0; k < LIBMESH_DIM; ++k)
...
Real
anaFiniteStrainHyperElasticViscoPlastic::computeNorm(const std::vector<Real> & var)
{
  Real val = 0.0;
...
void
anaFiniteStrainHyperElasticViscoPlastic::updateFlowRate()
{
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeQpJacobian()
{
...
bool
anaFiniteStrainHyperElasticViscoPlastic::computeIntVarRates()
{
  Real val = 0;
  for (unsigned int i = 0; i < _num_int_var_rate_uos; ++i)
  {
...
bool
anaFiniteStrainHyperElasticViscoPlastic::computeIntVar()
{
  Real val = 0;
  for (unsigned int i = 0; i < _num_int_var_uos; ++i)
  {
...
bool
anaFiniteStrainHyperElasticViscoPlastic::computeStrength()
{
  Real val = 0;
  for (unsigned int i = 0; i < _num_strength_uos; ++i)
  {
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeIntVarRateDerivatives()
{
  Real val = 0;
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeIntVarDerivatives()
{
  Real val = 0;
...
void
anaFiniteStrainHyperElasticViscoPlastic::computeStrengthDerivatives()
{
  Real val = 0;
