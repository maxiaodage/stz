...
stzHeatConductionTimeDerivativeCouple::stzHeatConductionTimeDerivativeCouple(const InputParameters & parameters) :
...
void
stzHeatConductionTimeDerivativeCouple::initialSetup()
{
...
Real
stzHeatConductionTimeDerivativeCouple::computeQpResidual()
{
  return (*_specific_heat)[_qp] * (*_density)[_qp] * TimeDerivative::computeQpResidual();
}

Real
stzHeatConductionTimeDerivativeCouple::computeQpJacobian()
{
