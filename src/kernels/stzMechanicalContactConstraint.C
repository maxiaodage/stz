...
template<>
InputParameters validParams<stzMechanicalContactConstraint>()
{
...
stzMechanicalContactConstraint::stzMechanicalContactConstraint(const InputParameters & parameters) :
...
void
stzMechanicalContactConstraint::timestepSetup()
{
  if (_component == 0)
  {
...
void
stzMechanicalContactConstraint::jacobianSetup()
{
  if (_component == 0)
  {
...
void
stzMechanicalContactConstraint::updateContactSet(bool beginning_of_step)
{
...
bool
stzMechanicalContactConstraint::shouldApply()
{
...
void
stzMechanicalContactConstraint::computeContactForce(PenetrationInfo * pinfo)
{
...
Real
stzMechanicalContactConstraint::computeQpSlaveValue()
{
  return _u_slave[_qp];
}

Real
stzMechanicalContactConstraint::computeQpResidual(Moose::ConstraintType type)
{
...
Real
stzMechanicalContactConstraint::computeQpJacobian(Moose::ConstraintJacobianType type)
{
  PenetrationInfo * pinfo = _penetration_locator._penetration_info[_current_node->id()];
...
Real
stzMechanicalContactConstraint::computeQpOffDiagJacobian(Moose::ConstraintJacobianType type,
                                                      unsigned int jvar)
{
  PenetrationInfo * pinfo = _penetration_locator._penetration_info[_current_node->id()];
...
Real
stzMechanicalContactConstraint::nodalArea(PenetrationInfo & pinfo)
{
  const Node * node = pinfo._node;
...
Real
stzMechanicalContactConstraint::getPenalty(PenetrationInfo & pinfo)
{
...
void
stzMechanicalContactConstraint::computeJacobian()
{
...
void
stzMechanicalContactConstraint::computeOffDiagJacobian(unsigned int jvar)
{
...
void
stzMechanicalContactConstraint::getConnectedDofIndices(unsigned int var_num)
{
...
bool
stzMechanicalContactConstraint::getCoupledVarComponent(unsigned int var_num,
                                                    unsigned int &component)
{
