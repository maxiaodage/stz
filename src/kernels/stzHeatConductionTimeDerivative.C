...
stzHeatConductionTimeDerivative::stzHeatConductionTimeDerivative(const InputParameters & parameters) :
...
void
stzHeatConductionTimeDerivative::initialSetup()
{
...
Real
stzHeatConductionTimeDerivative::computeQpResidual()
{
  return (*_specific_heat)[_qp] * (*_density)[_qp] * TimeDerivative::computeQpResidual();
}

Real
stzHeatConductionTimeDerivative::computeQpJacobian()
{
