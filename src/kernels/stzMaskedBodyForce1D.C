...
InputParameters validParams<stzMaskedBodyForce1D>()
{
  ...
  params.addParam<Real>("chihat",0.01,"Steady state Value of chi");
...
stzMaskedBodyForce1D::stzMaskedBodyForce1D(const InputParameters & parameters) :
...
Real
stzMaskedBodyForce1D::computeQpResidual()
{
